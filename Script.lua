...
if not getgenv().MTAPIMutex then loadstring(game:HttpGet("https://raw.githubusercontent.com/TomB8C/yes/main/api.lua", true))() end
...
local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/TomB8C/yes/main/Library.lua'))()
local SaveManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/TomB8C/yes/main/SaveManager.lua'))()
